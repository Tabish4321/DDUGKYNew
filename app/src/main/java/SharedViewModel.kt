...
class SharedViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _SaveCandidateOjtVerification =
        MutableLiveData<Result<SaveCandidateOjtVerificationResponse>>()
    val SaveCandidateOjtVerification: LiveData<Result<SaveCandidateOjtVerificationResponse>> =
        _SaveCandidateOjtVerification

    private val _CandidateOjtVerificationDetails =
        MutableLiveData<Result<CandidateOjtVerificationDetails>>()
    val CandidateOjtVerificationDetails: LiveData<Result<CandidateOjtVerificationDetails>> =
        _CandidateOjtVerificationDetails
    ...
    val ojtTrainingCenterRequest: LiveData<Result<OJT_TrainingCenter_Res>> =
        _ojtTrainingCenterRequest
    val ojtSanctionNo: LiveData<Result<OJT_Sanction_Res>> = _ojtSanctionNo
    private val _QuestiontReq =
        MutableLiveData<Result<QuestionResponse>>()

    val QuestiontReq: LiveData<Result<QuestionResponse>> =
        _QuestiontReq
    private val _insertresultsubmit =
        MutableLiveData<Result<FinalSubmitResponse>>()

    val insertresultsubmit: LiveData<Result<FinalSubmitResponse>> =
        _insertresultsubmit

    private val _insertsubmit =
        MutableLiveData<Result<SubmitResponse>>()
    ...
    private val _submitFieldVerification =
        MutableLiveData<Result<FieldVerificationDetailResponse>>()
    val submitFieldVerificationDetails: LiveData<Result<FieldVerificationDetailResponse>> =
        _submitFieldVerification

    private val _submitFieldVerificationNEW =
        MutableLiveData<Result<FieldVerificationDetailResponseNEW>>()
    val submitFieldVerificationDetailsNEW: LiveData<Result<FieldVerificationDetailResponseNEW>> =
        _submitFieldVerificationNEW
...
//    }
    ...
    fun submitFieldVerificationNew(request: FieldVerificationFinalSubmitNEW) {
        handleApiCall(
            apiCall = {
                repositoryManager.fieldVerification.submitFieldVerificationNEW(request)
            },
            resultLiveData = _submitFieldVerificationNEW
        )
    }
...
//    getCandidateByOjt
    ...
    fun getgetresultDetail(request: FieldVerificationDetailRequest) {
        handleApiCall(
            apiCall = { repositoryManager.fieldVerification.getgetresultDetail(request) },
            resultLiveData = _fieldDetail
        )
    }
    ...
    private val _getresultAll =
        MutableLiveData<Result<MyTestResponse>>()

    val getresultAll: LiveData<Result<MyTestResponse>> =
        _getresultAll

    fun getresultAll(request: EsopResultRequest, token: String) {
        handleApiCall(
            apiCall = {
                repositoryManager.esop.getresultAll(
                    request,
                    token
                )
            },
            resultLiveData = _getresultAll
        )
    }



    private val _getResultView =
        MutableLiveData<Result<GetResultItem>>()

    val getResultView: LiveData<Result<GetResultItem>> =
        _getResultView

    fun getResultView(request: GetResultViewRequest, token: String) {
        handleApiCall(
            apiCall = {
                repositoryManager.esop.getResultView(
                    request,
                    token
                )
            },
            resultLiveData = _getResultView
        )
    }
    ...
    fun QuestiontReq(request: QuestiontReq, token: String) {
        handleApiCall(
            apiCall = {
                repositoryManager.esop.getQuestionsView(
                    request,
                    token
                )
            },
            resultLiveData = _QuestiontReq
        )
    }
    ...
    fun insertresultsubmit(request: SubmitExamRequest, token: String) {
        handleApiCall(
            apiCall = {
                repositoryManager.esop.insertresultsubmit(
                    request,
                    token
                )
            },
            resultLiveData = _insertsubmit
        )
    }
    ...
    fun insertfinalsubmit(request: InsertRequest, token: String) {
        handleApiCall(
            apiCall = {
                repositoryManager.esop.insertfinalsubmit(
                    request,
                    token
                )
            },
