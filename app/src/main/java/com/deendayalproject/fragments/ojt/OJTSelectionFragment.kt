...
import com.deendayalproject.databinding.FragmentOnJobSelectionBinding
...
class OJTSelectionFragment : BaseFragment<FragmentOnJobSelectionBinding>(FragmentOnJobSelectionBinding::inflate) {
